...
#ifndef CLOVERGOCLIENT_SWIFT_H
#define CLOVERGOCLIENT_SWIFT_H
...
typedef SWIFT_ENUM(NSInteger, CLVGoTransactionType, open) {
...
typedef SWIFT_ENUM(NSInteger, CardReaderErrorEvent, open) {
...
typedef SWIFT_ENUM(NSInteger, CardReaderInitializationEvent, open) {
...
typedef SWIFT_ENUM(NSInteger, MerchantPropertyType, open) {
...
typedef SWIFT_ENUM(NSInteger, OfflineTransactionState, open) {
...
typedef SWIFT_ENUM(NSInteger, CardReaderType, open) {
...
typedef SWIFT_ENUM(NSInteger, TransactionErrorEvent, open) {
...
typedef SWIFT_ENUM(NSInteger, TransactionEvent, open) {
